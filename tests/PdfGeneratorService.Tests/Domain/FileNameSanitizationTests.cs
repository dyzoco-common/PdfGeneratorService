...
public sealed class FileNameSanitizationTests
{
    ...
    {
        var request = PdfGenerationRequest.Create("<p/>", "myfile", null, false, true,
    ...
    {
        var request = PdfGenerationRequest.Create("<p/>", "my:file/name?", null, false, true,
            new PdfMargins(null, null, null, null));
    ...
    {
        var request = PdfGenerationRequest.Create("<p/>", null, null, false, true,
            new PdfMargins(null, null, null, null));
    ...
    {
        var request = PdfGenerationRequest.Create("<p/>", "report-2024.pdf", null, false, true,
            new PdfMargins(null, null, null, null));
